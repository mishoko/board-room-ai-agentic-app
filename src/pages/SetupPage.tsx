...
const SetupPage: React.FC<SetupPageProps> = ({ onSessionStart }) => {
  ...
  const startSession = async () => {
    ...
    setGenerationProgress('Initializing sophisticated AI executive agents...');

    try {
      // Generate personalized responses for all agents and topics
      const llmService = LLMService.getInstance();
      
      setGenerationProgress('Analyzing company context and strategic priorities...');
      ...
      setGenerationProgress('Generating sophisticated executive responses and strategic insights...');
      ...
      setGenerationProgress('Preparing boardroom for intense executive discussions...');
      ...
      setGenerationProgress('Launching sophisticated boardroom experience...');
      ...
      setGenerationProgress('Error occurred. Using sophisticated fallback responses...');
  ...
  // Enhanced loading overlay for response generation
      ...
      <div className="min-h-screen bg-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
          <div className="text-center max-w-md">
            ...
            <p className="text-slate-300 mb-6 text-lg">{generationProgress}</p>
