...
const SetupPage: React.FC<SetupPageProps> = ({ onSessionStart }) => {
  ...
  const availableAgents: Omit<Agent, 'id' | 'isActive'>[] = [
    {
      ...
      persona: 'Visionary leader focused on strategic direction and stakeholder value',
      experience: '15+ years in executive leadership across multiple industries',
      expertise: ['Strategic Planning', 'Leadership', 'Stakeholder Management', 'Vision Setting', 'Corporate Governance']
    },
    {
      role: 'CTO',
      name: 'Chief Technology Officer',
      persona: 'Technical innovator balancing cutting-edge solutions with practical implementation',
      experience: '12+ years in technology leadership and software architecture',
      expertise: ['Technology Strategy', 'Software Architecture', 'Engineering Management', 'Innovation', 'Digital Transformation']
    },
    {
      role: 'CFO',
      name: 'Chief Financial Officer',
      persona: 'Financial strategist ensuring sustainable growth and fiscal responsibility',
      experience: '10+ years in financial management and corporate finance',
      expertise: ['Financial Planning', 'Risk Management', 'Investment Strategy', 'Corporate Finance', 'Budgeting']
    },
    {
      role: 'CMO',
      name: 'Chief Marketing Officer',
      persona: 'Brand champion driving customer acquisition and market positioning',
      experience: '8+ years in marketing leadership and brand management',
      expertise: ['Brand Strategy', 'Digital Marketing', 'Customer Acquisition', 'Market Research', 'Growth Marketing']
    },
    {
      role: 'CHRO',
      name: 'Chief Human Resources Officer',
      persona: 'People-first leader building organizational culture and talent strategy',
      experience: '10+ years in human resources and organizational development',
      expertise: ['Talent Management', 'Organizational Culture', 'Employee Development', 'Compensation Strategy', 'Change Management']
    },
    {
      role: 'COO',
      name: 'Chief Operating Officer',
      persona: 'Operations expert ensuring efficient execution and scalable processes',
      experience: '12+ years in operations management and process optimization',
      expertise: ['Operations Management', 'Process Optimization', 'Supply Chain', 'Quality Management', 'Scaling Operations']
    },
    {
      role: 'CPO',
      name: 'Chief Product Officer',
      persona: 'Product visionary driving user-centric innovation and market fit',
      experience: '8+ years in product management and user experience design',
      expertise: ['Product Strategy', 'User Experience', 'Product Development', 'Market Research', 'Innovation Management']
    },
    {
      role: 'CVCO',
      name: 'Chief Vice Coding Officer',
      persona: 'Engineering excellence advocate ensuring code quality and developer productivity',
      experience: '10+ years in software engineering and development team leadership',
      expertise: ['Code Quality', 'Engineering Practices', 'Developer Experience', 'Technical Mentorship', 'Software Architecture']
    },
    {
      role: 'CRO',
      name: 'Chief Revenue Officer',
      persona: 'Revenue growth specialist optimizing sales processes and customer success',
      experience: '9+ years in sales leadership and revenue operations',
      expertise: ['Sales Strategy', 'Revenue Operations', 'Customer Success', 'Sales Process', 'Growth Strategy']
    },
    {
      role: 'CISO',
      ...
      expertise: ['Cybersecurity', 'Risk Management', 'Compliance', 'Security Architecture', 'Incident Response']
    },
    {
      role: 'CLO',
      name: 'Chief Legal Officer',
      persona: 'Legal strategist ensuring compliance while enabling business growth',
      experience: '12+ years in corporate law and regulatory compliance',
      expertise: ['Corporate Law', 'Regulatory Compliance', 'Contract Management', 'Intellectual Property', 'Risk Mitigation']
    },
    {
      role: 'CDO',
      name: 'Chief Data Officer',
      persona: 'Data strategist transforming information into competitive advantage',
      experience: '8+ years in data science and analytics leadership',
      expertise: ['Data Strategy', 'Analytics', 'Data Governance', 'Business Intelligence', 'Data Science']
    },
    {
      role: 'CSO',
      name: 'Chief Strategy Officer',
      persona: 'Strategic planner focusing on long-term competitive positioning',
      experience: '10+ years in strategic planning and business development',
      expertise: ['Strategic Planning', 'Competitive Analysis', 'Business Development', 'Market Strategy', 'Corporate Strategy']
    },
    {
      role: 'CHCO',
      name: 'Chief Happiness & Culture Officer',
      persona: 'Culture champion fostering employee wellbeing and organizational happiness',
      experience: '7+ years in organizational psychology and culture development',
      expertise: ['Employee Wellbeing', 'Culture Development', 'Organizational Psychology', 'Employee Engagement', 'Workplace Happiness']
    },
    {
      role: 'CAIO',
      name: 'Chief AI Officer',
      persona: 'AI strategist driving responsible artificial intelligence adoption',
      experience: '6+ years in AI/ML leadership and ethical AI development',
      expertise: ['AI Strategy', 'Machine Learning', 'Ethical AI', 'AI Governance', 'Automation Strategy']
    },
    {
      role: 'CGRO',
      name: 'Chief Growth & Revenue Officer',
      persona: 'Growth specialist combining marketing and sales for revenue optimization',
      experience: '9+ years in growth marketing and revenue strategy',
      expertise: ['Growth Strategy', 'Revenue Optimization', 'Customer Acquisition', 'Market Expansion', 'Performance Marketing']
    }
  ];
  ...
  const companyStages = ['Pre-seed', 'Seed', 'Series A', 'Series B', 'Series C+', 'IPO', 'Public', 'Mature'];

  const handleAgentToggle = (agentTemplate: Omit<Agent, 'id' | 'isActive'>) => {
    const agentId = `agent-${agentTemplate.role.toLowerCase()}`;
    const existingIndex = selectedAgents.findIndex(agent => agent.id === agentId);
    
    if (existingIndex >= 0) {
      setSelectedAgents(selectedAgents.filter((_, index) => index !== existingIndex));
    } else {
  ...
  const handleStartSession = async () => {
    ...
    try {
      // Generate AI responses for all agents and topics
      const llmService = LLMService.getInstance();
      const agentResponses = await llmService.generateAllAgentResponses(
      ...
      // Continue with session creation even if AI generation fails
      const session: BoardroomSession = {
        id: `session-${Date.now()}`,
        agents: selectedAgents,
        topics: topics,
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 'company':
        return companyContext.name && companyContext.industry && companyContext.size && companyContext.stage;
      case 'agents':
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-300">Tell us about your company to personalize the boardroom experience</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCompanyContext({...companyContext, name: e.target.value})}
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Select Executives</h2>
              <p className="text-slate-300">Choose the C-level executives for your boardroom discussion</p>
              <p className="text-sm text-slate-400 mt-2">Selected: {selectedAgents.length} executives</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {availableAgents.map((agent) => {
                const agentId = `agent-${agent.role.toLowerCase()}`;
                const isSelected = selectedAgents.some(selected => selected.id === agentId);
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className={`w-4 h-4 rounded-full border-2 ${
                        isSelected ? 'bg-purple-500 border-purple-500' : 'border-slate-400'
                      }`} />
                    </div>
                    <p className="text-sm opacity-90 mb-2">{agent.name}</p>
                    <p className="text-xs opacity-75 line-clamp-2">{agent.persona}</p>
                  </div>
                );
              })}
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-300">Define the topics your executives will discuss</p>
            </div>
              ...
              {topics.map((topic, index) => (
                <div key={topic.id} className="bg-slate-700/50 rounded-lg p-4 border border-slate-600">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-2">Topic Title</label>
                      <input
                        type="text"
                        value={topic.title}
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1">
                        ...
                        <select
                          ...
                          onChange={(e) => updateTopic(index, 'priority', e.target.value as 'high' | 'medium' | 'low')}
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          onChange={(e) => updateTopic(index, 'estimatedDuration', parseInt(e.target.value))}
                          className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
                          min="1"
                          max="60"
                        />
